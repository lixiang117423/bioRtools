...
#' \describe{
#'   \item{plot_volcano}{A ggplot object that can be further customized
#'     or directly displayed.}
#'   \item{data_summary}{A summary table showing the number of genes in
